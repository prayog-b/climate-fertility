...
/**********************************************************************/
	...
	*/
		...
		program define load_census_data
			...
			capture use "$cf/data/derived/census/africa-women-genvar.dta", clear
			if _rc {
	...
	*/
	...
	program define analyze_unmatched_smallest
		...
		preserve
			...
			shp2dta using "$cf/data/source/shapefiles/ipums/bpl_data_smallest_unit_africa.shp", data("$cf/data/temp/shapefile_data.dta") coor("$cf/data/temp/shapefile_coord.dta") genid(id) replace 
			use "$cf/data/temp/shapefile_data.dta", clear
	...
	* Main processing function
	...
	program define process_country 
		...
		*** Generate fixed effects variables 
		di "Generating fixed effects variables ..."
		egen COUNTRY_cohort = group(COUNTRY COHORT)
		egen COUNTRY_census = group(COUNTRY CENSUS)
		egen SMALLEST_cohort = group(MERGE_SMALLEST COHORT)
		egen SMALLEST_census = group(MERGE_SMALLEST CENSUS)
		rename MERGE_SMALLEST SMALLEST

		label variable COUNTRY_cohort "Country-Cohort Fixed Effects"
		label variable COUNTRY_census "Country-Census Fixed Effects"
		label variable SMALLEST_cohort "SMALLEST-Cohort Fixed Effects"
		label variable SMALLEST_census "SMALLEST-Census Fixed Effects"
		label variable SMALLEST "SMALLEST geographical unit ID"
		* Drop variables
		// drop drop_reason drop_step drop_details drop_timestamp dropped_geom_merge
...
/*------------------------------------ End of SECTION 3 - Main workflow ------------------------------*/
...
/**********************************************************************/
	...
	local test_codes "BFA IVC SLE ZAF"   // Start with just one country for testing
...
/**********************************************************************/
/*  SECTION 5:  Summary of implementation  			
...
/*------------------------------------ End of SECTION 5 - Summary of implementation------------------------------*/
